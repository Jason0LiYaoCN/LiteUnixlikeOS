...
801002bb:	68 80 a5 10 80       	push   $0x8010a580
...
801002ea:	68 80 a5 10 80       	push   $0x8010a580
...
80100348:	68 80 a5 10 80       	push   $0x8010a580
...
80100410 <consputc>:
  if(panicked){
80100410:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
...
8010071a:	68 80 a5 10 80       	push   $0x8010a580
...
801007eb:	68 80 a5 10 80       	push   $0x8010a580
...
8010081b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&cons.lock);
8010081e:	68 80 a5 10 80       	push   $0x8010a580
...
80100883:	68 80 a5 10 80       	push   $0x8010a580
...
801009cb:	68 80 a5 10 80       	push   $0x8010a580
...
801009ec:	02 10 80 
  cons.locking = 1;
801009ef:	c7 05 b4 a5 10 80 01 	movl   $0x1,0x8010a5b4
801009f6:	00 00 00 
  ioapicenable(IRQ_KBD, 0);
...
80101ed8:	68 c2 76 10 80       	push   $0x801076c2
...
8010201b:	68 e0 a5 10 80       	push   $0x8010a5e0
...
80102068:	74 f6                	je     80102060 <ideinit+0x50>
      havedisk1 = 1;
8010206a:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80102071:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
80102096:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
80102099:	68 e0 a5 10 80       	push   $0x8010a5e0
8010209e:	e8 ad 22 00 00       	call   80104350 <acquire>

  if((b = idequeue) == 0){
801020a3:	8b 1d c4 a5 10 80    	mov    0x8010a5c4,%ebx
...
801020b3:	a3 c4 a5 10 80       	mov    %eax,0x8010a5c4
...
80102101:	e8 3a 1e 00 00       	call   80103f40 <wakeup>
  ...
  if(idequeue != 0)
80102106:	a1 c4 a5 10 80       	mov    0x8010a5c4,%eax
...
8010211a:	68 e0 a5 10 80       	push   $0x8010a5e0
...
80102163:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
...
8010217d:	8b 15 c4 a5 10 80    	mov    0x8010a5c4,%edx
...
801021a4:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
801021a6:	39 1d c4 a5 10 80    	cmp    %ebx,0x8010a5c4
...
801021c3:	68 e0 a5 10 80       	push   $0x8010a5e0
...
801021d9:	75 e5                	jne    801021c0 <iderw+0x90>
  ...
  release(&idelock);
801021db:	c7 45 08 e0 a5 10 80 	movl   $0x8010a5e0,0x8(%ebp)
}
...
801021f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
80102200:	ba c4 a5 10 80       	mov    $0x8010a5c4,%edx
...
80102332:	81 fb 08 55 11 80    	cmp    $0x80115508,%ebx
...
80102557:	8b 0d 14 a6 10 80    	mov    0x8010a614,%ecx
...
80102595:	89 c8                	mov    %ecx,%eax
  shift ^= togglecode[data];
80102597:	89 0d 14 a6 10 80    	mov    %ecx,0x8010a614
  c = charcode[shift & (CTL | SHIFT)][data];
...
801025d9:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
801025db:	89 0d 14 a6 10 80    	mov    %ecx,0x8010a614
}
801025e1:	5b                   	pop    %ebx
801025e2:	5d                   	pop    %ebp
801025e3:	c3                   	ret    
...
801025eb:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
801025ed:	89 0d 14 a6 10 80    	mov    %ecx,0x8010a614
    return 0;
801025f3:	c3                   	ret    
...
80102ec7:	68 08 55 11 80       	push   $0x80115508
...
80102f1a:	68 ec a4 10 80       	push   $0x8010a4ec
...
80103127:	a3 dc 26 11 80       	mov    %eax,0x801126dc
...
80103195:	8d 76 00             	lea    0x0(%esi),%esi
      if(ncpu < NCPU) {
80103198:	8b 0d 60 2d 11 80    	mov    0x80112d60,%ecx
...
801031b0:	89 0d 60 2d 11 80    	mov    %ecx,0x80112d60
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
801031b6:	88 97 e0 27 11 80    	mov    %dl,-0x7feed820(%edi)
...
801031cc:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
801031cf:	88 15 c0 27 11 80    	mov    %dl,0x801127c0
      continue;
...
80103614:	bb b4 2d 11 80       	mov    $0x80112db4,%ebx
{
80103619:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010361c:	68 80 2d 11 80       	push   $0x80112d80
...
80103633:	81 fb b4 4c 11 80    	cmp    $0x80114cb4,%ebx
...
80103654:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103657:	68 80 2d 11 80       	push   $0x80112d80
  p->pid = nextpid++;
...
801036b3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036b5:	68 80 2d 11 80       	push   $0x80112d80
...
801036e3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036e6:	68 80 2d 11 80       	push   $0x80112d80
...
8010373b:	68 80 2d 11 80       	push   $0x80112d80
...
8010375c:	e8 df ef ff ff       	call   80102740 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103761:	8b 35 60 2d 11 80    	mov    0x80112d60,%esi
80103767:	85 f6                	test   %esi,%esi
80103769:	7e 42                	jle    801037ad <mycpu+0x5d>
    if (cpus[i].apicid == apicid)
8010376b:	0f b6 15 e0 27 11 80 	movzbl 0x801127e0,%edx
80103772:	39 d0                	cmp    %edx,%eax
80103774:	74 30                	je     801037a6 <mycpu+0x56>
80103776:	b9 90 28 11 80       	mov    $0x80112890,%ecx
  for (i = 0; i < ncpu; ++i) {
...
8010379a:	05 e0 27 11 80       	add    $0x801127e0,%eax
}
...
801037a5:	c3                   	ret    
    if (cpus[i].apicid == apicid)
801037a6:	b8 e0 27 11 80       	mov    $0x801127e0,%eax
      return &cpus[i];
...
801037db:	2d e0 27 11 80       	sub    $0x801127e0,%eax
}
801037e0:	c9                   	leave  
  return mycpu()-cpus;
...
8010382c:	89 c3                	mov    %eax,%ebx
  initproc = p;
8010382e:	a3 18 a6 10 80       	mov    %eax,0x8010a618
...
8010384b:	68 c0 a4 10 80       	push   $0x8010a4c0
...
801038d6:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
801038d9:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
801038e0:	e8 6b 0a 00 00       	call   80104350 <acquire>
  p->state = RUNNABLE;
801038e5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801038ec:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103a46:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a49:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
80103a50:	e8 fb 08 00 00       	call   80104350 <acquire>
  np->state = RUNNABLE;
80103a55:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a5c:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103ad1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ad4:	bb b4 2d 11 80       	mov    $0x80112db4,%ebx
    acquire(&ptable.lock);
80103ad9:	68 80 2d 11 80       	push   $0x80112d80
...
80103b2c:	81 fb b4 4c 11 80    	cmp    $0x80114cb4,%ebx
80103b32:	72 bc                	jb     80103af0 <scheduler+0x40>
    release(&ptable.lock);
80103b34:	83 ec 0c             	sub    $0xc,%esp
80103b37:	68 80 2d 11 80       	push   $0x80112d80
...
80103b6d:	68 80 2d 11 80       	push   $0x80112d80
...
80103c29:	e8 92 06 00 00       	call   801042c0 <popcli>
  if(curproc == initproc)
80103c2e:	39 35 18 a6 10 80    	cmp    %esi,0x8010a618
...
80103c74:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103c7b:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103cb7:	3d b4 4c 11 80       	cmp    $0x80114cb4,%eax
80103cbc:	72 e4                	jb     80103ca2 <exit+0x92>
      p->parent = initproc;
80103cbe:	8b 0d 18 a6 10 80    	mov    0x8010a618,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cc4:	ba b4 2d 11 80       	mov    $0x80112db4,%edx
80103cc9:	eb 10                	jmp    80103cdb <exit+0xcb>
80103ccb:	90                   	nop
80103ccc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103cd0:	83 c2 7c             	add    $0x7c,%edx
80103cd3:	81 fa b4 4c 11 80    	cmp    $0x80114cb4,%edx
...
80103ce7:	75 e7                	jne    80103cd0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ce9:	b8 b4 2d 11 80       	mov    $0x80112db4,%eax
80103cee:	eb 0a                	jmp    80103cfa <exit+0xea>
80103cf0:	83 c0 7c             	add    $0x7c,%eax
80103cf3:	3d b4 4c 11 80       	cmp    $0x80114cb4,%eax
...
80103d47:	68 80 2d 11 80       	push   $0x80112d80
...
80103d6d:	e8 de fd ff ff       	call   80103b50 <sched>
  release(&ptable.lock);
80103d72:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103dc0:	81 fe 80 2d 11 80    	cmp    $0x80112d80,%esi
80103dc6:	74 50                	je     80103e18 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103dc8:	83 ec 0c             	sub    $0xc,%esp
80103dcb:	68 80 2d 11 80       	push   $0x80112d80
...
80103dec:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103df3:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103ea1:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ea6:	81 fb b4 4c 11 80    	cmp    $0x80114cb4,%ebx
...
80103ebc:	68 80 2d 11 80       	push   $0x80112d80
...
80103ee9:	e8 f2 2c 00 00       	call   80106be0 <freevm>
        release(&ptable.lock);
80103eee:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
        p->pid = 0;
...
80103f29:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f2e:	68 80 2d 11 80       	push   $0x80112d80
...
80103f7f:	3d b4 4c 11 80       	cmp    $0x80114cb4,%eax
80103f84:	72 e4                	jb     80103f6a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80103f86:	c7 45 08 80 2d 11 80 	movl   $0x80112d80,0x8(%ebp)
}
...
80103fe6:	68 80 2d 11 80       	push   $0x80112d80
...
80104003:	68 80 2d 11 80       	push   $0x80112d80
...
80104026:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104029:	bb b4 2d 11 80       	mov    $0x80112db4,%ebx
{
...
8010486c:	8b 14 85 40 76 10 80 	mov    -0x7fef89c0(,%eax,4),%edx
...
801049e4:	68 b8 76 10 80       	push   $0x801076b8
...
801049fc:	68 b7 76 10 80       	push   $0x801076b7
...
80104a15:	68 ab 76 10 80       	push   $0x801076ab
...
80104a2a:	68 ba 76 10 80       	push   $0x801076ba
80104a2f:	e8 5c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a34:	83 ec 0c             	sub    $0xc,%esp
80104a37:	68 9c 76 10 80       	push   $0x8010769c
...
80104e29:	58                   	pop    %eax
80104e2a:	5a                   	pop    %edx
80104e2b:	68 b8 76 10 80       	push   $0x801076b8
...
80104e44:	68 b7 76 10 80       	push   $0x801076b7
...
80105580:	68 c0 4c 11 80       	push   $0x80114cc0
...
8010558d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105590:	8b 1d 00 55 11 80    	mov    0x80115500,%ebx
  while(ticks - ticks0 < n){
...
801055a3:	68 c0 4c 11 80       	push   $0x80114cc0
801055a8:	68 00 55 11 80       	push   $0x80115500
801055ad:	e8 de e7 ff ff       	call   80103d90 <sleep>
  while(ticks - ticks0 < n){
801055b2:	a1 00 55 11 80       	mov    0x80115500,%eax
...
80105614:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105617:	68 c0 4c 11 80       	push   $0x80114cc0
8010561c:	e8 2f ed ff ff       	call   80104350 <acquire>
  xticks = ticks;
80105621:	8b 1d 00 55 11 80    	mov    0x80115500,%ebx
  release(&tickslock);
80105627:	c7 04 24 c0 4c 11 80 	movl   $0x80114cc0,(%esp)
...
80105646:	8d 45 08             	lea    0x8(%ebp),%eax
...
8010565d:	ff 75 08             	pushl  0x8(%ebp)
80105660:	e8 bb d1 ff ff       	call   80102820 <cmostime>
  return 0;
...
801056b0:	8b 14 85 7c a0 10 80 	mov    -0x7fef5f84(,%eax,4),%edx
801056b7:	c7 04 c5 02 4d 11 80 	movl   $0x8e000008,-0x7feeb2fe(,%eax,8)
801056be:	08 00 00 8e 
801056c2:	66 89 14 c5 00 4d 11 	mov    %dx,-0x7feeb300(,%eax,8)
801056c9:	80 
801056ca:	c1 ea 10             	shr    $0x10,%edx
801056cd:	66 89 14 c5 06 4d 11 	mov    %dx,-0x7feeb2fa(,%eax,8)
801056d4:	80 
  for(i = 0; i < 256; i++)
...
801056df:	a1 7c a1 10 80       	mov    0x8010a17c,%eax

  initlock(&tickslock, "time");
801056e4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056e7:	c7 05 02 4f 11 80 08 	movl   $0xef000008,0x80114f02
801056ee:	00 00 ef 
  initlock(&tickslock, "time");
801056f1:	68 00 76 10 80       	push   $0x80107600
801056f6:	68 c0 4c 11 80       	push   $0x80114cc0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056fb:	66 a3 00 4f 11 80    	mov    %ax,0x80114f00
80105701:	c1 e8 10             	shr    $0x10,%eax
80105704:	66 a3 06 4f 11 80    	mov    %ax,0x80114f06
  initlock(&tickslock, "time");
...
8010572b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010572f:	b8 00 4d 11 80       	mov    $0x80114d00,%eax
...
80105770:	ff 24 85 a0 77 10 80 	jmp    *-0x7fef8860(,%eax,4)
...
801057d5:	68 5c 77 10 80       	push   $0x8010775c
...
80105917:	68 04 77 10 80       	push   $0x80107704
...
801059b5:	68 28 77 10 80       	push   $0x80107728
801059ba:	e8 a1 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
801059bf:	83 c4 14             	add    $0x14,%esp
801059c2:	68 fd 76 10 80       	push   $0x801076fd
...
{
  if(!uart)
801059d0:	a1 1c a6 10 80       	mov    0x8010a61c,%eax
{
...
80105aa7:	74 5a                	je     80105b03 <uartinit+0xb3>
  uart = 1;
80105aa9:	c7 05 1c a6 10 80 01 	movl   $0x1,0x8010a61c
80105ab0:	00 00 00 
...
80105ae8:	74 19                	je     80105b03 <uartinit+0xb3>
  if(!uart)
80105aea:	8b 15 1c a6 10 80    	mov    0x8010a61c,%edx
...
80105b10 <uartputc>:
  if(!uart)
80105b10:	8b 15 1c a6 10 80    	mov    0x8010a61c,%edx
{
...
8010679a:	c7 80 58 28 11 80 ff 	movl   $0xffff,-0x7feed7a8(%eax)
801067a1:	ff 00 00 
801067a4:	c7 80 5c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7a4(%eax)
801067ab:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067ae:	c7 80 60 28 11 80 ff 	movl   $0xffff,-0x7feed7a0(%eax)
801067b5:	ff 00 00 
801067b8:	c7 80 64 28 11 80 00 	movl   $0xcf9200,-0x7feed79c(%eax)
801067bf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067c2:	c7 80 68 28 11 80 ff 	movl   $0xffff,-0x7feed798(%eax)
801067c9:	ff 00 00 
801067cc:	c7 80 6c 28 11 80 00 	movl   $0xcffa00,-0x7feed794(%eax)
801067d3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067d6:	c7 80 70 28 11 80 ff 	movl   $0xffff,-0x7feed790(%eax)
801067dd:	ff 00 00 
801067e0:	c7 80 74 28 11 80 00 	movl   $0xcff200,-0x7feed78c(%eax)
801067e7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801067ea:	05 50 28 11 80       	add    $0x80112850,%eax
  pd[1] = (uint)p;
...
80106810:	a1 04 55 11 80       	mov    0x80115504,%eax
{
...
801069a9:	68 6d 78 10 80       	push   $0x8010786d
...
80106b0d:	68 a5 78 10 80       	push   $0x801078a5
...
80106b43:	68 bd 78 10 80       	push   $0x801078bd
...
80106c4c:	68 d9 78 10 80       	push   $0x801078d9
...
80106c73:	bb 80 a4 10 80       	mov    $0x8010a480,%ebx
  memset(pgdir, 0, PGSIZE);
...
80106caa:	81 fb c0 a4 10 80    	cmp    $0x8010a4c0,%ebx
...
80106ceb:	a3 04 55 11 80       	mov    %eax,0x80115504
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106d1f:	68 ea 78 10 80       	push   $0x801078ea
...
80106e09:	68 0e 79 10 80       	push   $0x8010790e
80106e0e:	e8 7d 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106e13:	83 ec 0c             	sub    $0xc,%esp
80106e16:	68 f4 78 10 80       	push   $0x801078f4
